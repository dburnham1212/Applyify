...
const Login = () => {
  ...
  return(
    <div className="flex justify-center pt-6">
      <div className="w-5/6 sm:w-3/4 md:w-2/3 lg:w-1/2 block rounded-lg p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-secondary" >
        <div className="flex justify-center mx-2 my-4 text-3xl font-bold text-secondary-content">
          <h2>Login</h2>
        </div>
        <form className="px-3">
