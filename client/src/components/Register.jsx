...
const Register = () => {
  return (
    <div className="d-flex justify-content-center py-5">
      <div className="card col-10 col-sm-8 col-md-7 col-lg-6 col-xl-4 text-center">
        ...
        <form className="px-3">
          ...
          <div className="form-group pt-4">
            <label>Email</label>
            <input className="form-control" type="email" placeholder="example@example.com"></input>
          </div>
          <div className="form-group pt-4">
